...
def main():
    ...
    output_dir = os.path.join(os.getcwd(), "phi3")
    cache_dir = setup_cache_dir()  # Cache directory setup for both model and dataset

    # Load processor and model with the specified cache directory
